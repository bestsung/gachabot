    ...
    this.commandHandler = new CommandHandler(this, {
      ...
      argumentDefaults: {
        prompt: {
          ...
          modifyTimeout: () => ({ embeds: [CreateEmbed('warn', '⛔ | หมดเวลาใช้คำสั่ง')] }),
          modifyEnded: () => ({ embeds: [CreateEmbed('warn', '⛔ | สิ้นสุดคำสั่ง')] }),
          modifyCancel: () => ({ embeds: [CreateEmbed('info', '⛔ | อาร์กิวเมนต์ไม่ถูกต้อง เซสชันคำสั่งสิ้นสุดลง')] }),
          retries: 3,
          time: 30000,
        },
      },
